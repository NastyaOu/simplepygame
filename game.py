...
player = Person(100, 320, 4, 'player.png')
allplayers = [player] #СПИСОК, ПО НЕМУ БУДЕМ ПРОХОДИТСЯ В БЕСКОНЕЧНОМ ИГРОВОМ ЦИКЛЕ, ЧТОБЫ ВСЕ ПРОТИВНИКИ И ИГРОК ДВИГАЛИСЬ
